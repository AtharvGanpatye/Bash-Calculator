...
typedef struct token{
	...
	union data{
           int num; // will be used if type==OPERAND
...
float evalfloat(char* str){
	...
	/*10 20 + 20 = 30. Error handling to be done.*/
...
int main(int argc, char* argv[]){
	...
	printf("\t\t\tCopyright(c)2019 ------------> Atharv Ganpatye ------------> 111803050\n");
	printf("\t\t\tThis is free software with ABSOLUTELY NO WARRANTY.\n\n");
	printf("\tFor Trigonometric Functions\t--l\n");
